...
def match_reads(reads_count_total):
	...
	true_variant_groups[group] = factor_total
	...
	for reads_for_one_fn in factor_reads_pool.groupby('fn'):
		...
		random_fold = 2
    		...
    		random_variant_fni = np.array([a for b in random_variant_fni for a in b]  )
    ...
    return [true_variant_groups, random_variant_groups]
...
if __name__ == '__main__':
	...
	[_, matched_random_variants] = match_reads(df)
