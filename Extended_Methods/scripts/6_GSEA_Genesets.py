...
for topGene_N in list(range(2,8)) + [30]:
...
for tis_index in range(len(Comp_tissues)):
    ...
    tested_genes_dat[['gene_id', 'gene_name']].to_csv('%s/Revision_Zscore/tested_genes/%s_genes_%s.txt' % (inputdatadir, tis_index, FMfn), sep='\t', index = False, header=None)
