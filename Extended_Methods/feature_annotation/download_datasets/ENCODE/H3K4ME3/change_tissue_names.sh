...
sed -i "/angular gyrus/d" ${file}
sed -i "/duodenal mucosa/d" ${file}
sed -i "/germinal matrix/d" ${file}
sed -i "/layer of hippocampus/d" ${file}
sed -i "/middle frontal area 46/d" ${file}
sed -i "/muscle layer of duodenum/d" ${file}
sed -i "/parathyroid adenoma/d" ${file}
sed -i "/placental basal plate/d" ${file}
sed -i "/temporal lobe/d" ${file}
sed -i "/thoracic aorta/d" ${file}
...
sed -i "s/esophagus squamous epithelium/Esophagus_Mucosa/g" ${file}
sed -i "s/esophagus/Esophagus_Mucosa/g" ${file}
...
sed -i "s/mucosa of stomach/Stomach/g" ${file}
sed -i "s/stomach smooth muscle/Stomach/g" ${file}
sed -i "s/tibial nerve/Nerve_Tibial/g" ${file}
sed -i "s/spleen/Spleen/g" ${file}
sed -i "s/thyroid gland/Thyroid/g" ${file}
sed -i "s/aorta/Artery_Aorta/g" ${file}
...
sed -i "s/subcutaneous abdominal adipose tissue/Adipose_Subcutaneous/g" ${file}

sed -i "s/breast epithelium/Breast_Mammary_Tissue/g" ${file}
...
sed -i "s/right cardiac atrium/Heart_Atrial_Appendage/g" ${file}
...
sed -i "s/endocrine pancreas/Pancreas/g" ${file}
...
sed -i "s/cingulate gyrus/Brain_Anterior_cingulate_cortex_BA24/g" ${file}
sed -i "s/substantia nigra/Brain_Substantia_nigra/g" ${file}


sed -i "s/skeletal muscle tissue/Muscle_Skeletal/g" ${file}
