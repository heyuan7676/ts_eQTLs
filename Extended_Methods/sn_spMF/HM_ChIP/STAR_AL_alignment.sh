...
fn_rep=${fastq_dir}/ENCFF526GZR.fastq
outputfn=${outputdir}/liver_H3K27me3_seq
./STAR --genomeDir ${genome_index_idr}  --runThreadN 6 --readFilesIn ${fn_rep} --readFilesCommand zcat --outFileNamePrefix ${outputfn} --varVCFfile ${vcfFn} --outSAMattributes NH HI AS nM NM MD vA vG vW --outSAMtype BAM SortedByCoordinate --waspOutputMode SAMtag

fn_rep=${fastq_dir}/ENCFF299RVY.fastq
outputfn=${outputdir}/liver_H3K9me3_seq
./STAR --genomeDir ${genome_index_idr}  --runThreadN 6 --readFilesIn ${fn_rep} --readFilesCommand zcat --outFileNamePrefix ${outputfn} --varVCFfile ${vcfFn} --outSAMattributes NH HI AS nM NM MD vA vG vW --outSAMtype BAM SortedByCoordinate --waspOutputMode SAMtag

fn_rep=${fastq_dir}/ENCFF624UHE.fastq
outputfn=${outputdir}/liver_H3K36me3_seq
./STAR --genomeDir ${genome_index_idr}  --runThreadN 6 --readFilesIn ${fn_rep}  --readFilesCommand zcat  --outFileNamePrefix ${outputfn} --varVCFfile ${vcfFn} --outSAMattributes NH HI AS nM NM MD vA vG vW --outSAMtype BAM SortedByCoordinate --waspOutputMode SAMtag

fn_rep=${fastq_dir}/ENCFF422ACR.fastq
outputfn=${outputdir}/liver_H3K4me1_seq
./STAR --genomeDir ${genome_index_idr}  --runThreadN 6 --readFilesIn ${fn_rep} --readFilesCommand zcat --outFileNamePrefix ${outputfn} --varVCFfile ${vcfFn} --outSAMattributes NH HI AS nM NM MD vA vG vW --outSAMtype BAM SortedByCoordinate --waspOutputMode SAMtag
...
fn_rep1=${fastq_dir}/ENCFF007GTB.fastq
fn_rep2=${fastq_dir}/ENCFF654JFS.fastq
outputfn=${outputdir}/liver_H3K27ac_seq
./STAR --genomeDir ${genome_index_idr}  --runThreadN 6 --readFilesIn ${fn_rep1},${fn_rep2} --readFilesCommand zcat  --outFileNamePrefix ${outputfn} --varVCFfile ${vcfFn} --outSAMattributes NH HI AS nM NM MD vA vG vW --outSAMtype BAM SortedByCoordinate --waspOutputMode SAMtag
