...
file3=/work-zfs/abattle4/heyuan/tissue_spec_eQTL_v8/datasets/cbset_datasets/input_pairs/tested_genes_in_cbset/${tis}_genes.txt
...
file1=Thresholding_eGenes_topGene6_${tis}.txt
file3=/work-zfs/abattle4/heyuan/tissue_spec_eQTL_v8/datasets/cbset_datasets/input_pairs/tested_genes_in_cbset/${tis}_genes.txt
